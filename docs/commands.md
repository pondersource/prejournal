...
|`print-timesheet-json`| Export Timesheet entry the first argument min value, the second max value, third project is optional | `php src/cli-single.php print-timesheet-json 0  100`| `curl -d'["0","100"]' https://example:password123@time.pondersource.com/v1/print-timesheet-json` |
